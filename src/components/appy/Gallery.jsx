                    ...
                    <div className="row">
                        ...
                        <div className="col-xs-12 col-sm-5 col-lg-3">
                            <div className="page-title">
                                <h5 className="white-color title wow fadeInUp" data-wow-delay="0.2s">Ảnh chụp màn hình</h5>
                                <div className="space-10"></div>
                                <h3 className="white-color wow fadeInUp" data-wow-delay="0.4s">Kết Nối Tài Chính Hiệu Quả</h3>
                            </div>
                            <div className="space-20"></div>
                            <div className="desc wow fadeInUp" data-wow-delay="0.6s">
                                <p>Giải pháp tài chính P2P là hình thức cho vay ngang hàng kết nối giữa người có nhu cầu vay và người cho vay.</p>
                            </div>
